        ...
        <div class="container-fluid">
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                    <?php 
                        $i = 1;
                        $qry = $conn->query("SELECT c.*,d.name as department from `program_list` c inner join department_list d on c.department_id = d.id where c.delete_flag = 0 order by c.`name` asc ");
...
<script>
    $(document).ready(function(){
        $('#create_new').click(function(){
            uni_modal("Add New Program","courses/manage_course.php")
        })
        ...
        $('.edit_data').click(function () {
            ...
            uni_modal("Update Program Details", "courses/manage_course.php?id=" + id);
        });

        $('.delete_data').click(function(){
            _conf("Are you sure to delete this Course permanently?","delete_program",[$(this).attr('data-id')])
        })
