...
<aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand bg-dark">
  <!-- Brand Logo -->
  <a href="<?php echo base_url ?>faculty" class="brand-link bg-transparent text-sm border-0 shadow-sm">
        ...
        <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
          ...
          <nav class="mt-4">
            <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
              <!-- Subject Section -->
              <li class="nav-header">Subject</li>
              <li class="nav-item">
                <a href="<?php echo base_url ?>faculty/?page=subjects/" class="nav-link nav-subjects">
              ...
              <li class="nav-item dropdown">
                <a href="<?php echo base_url ?>faculty/?page=subjects/manage_subject" class="nav-link nav-subjects_manage_subject">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url ?>faculty/?page=students/" class="nav-link nav-students">
              ...
              <li class="nav-item dropdown">
                <a href="<?php echo base_url ?>faculty/?page=system_info" class="nav-link nav-system_info">
